...
const Electronics = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://fakestoreapi.com/products/category/electronics')
      ...
      .catch(err => console.error('Failed to fetch electronics:', err));
  }, []);

  const handleAddToCart = (item) => toast.success(`${item.title} added to cart!`);
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      {electronics.length === 0 ? (
        <p className="text-gray-500 text-center">Loading electronics...</p>
      ) : (
